...
edge_folder_1 = '/stg3/data3/peiyao/work/20230922.Lina_lung/results/taiji/edges.1.new'
...
result_df.to_csv(os.path.join(edge_folder_2_20231019, 'regulatee_list.pval_sig.new_sig_TF.txt'), sep='\t', index=None, )
